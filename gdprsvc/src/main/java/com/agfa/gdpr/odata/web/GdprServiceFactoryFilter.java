 ...
 * 
 */
public class GdprServiceFactoryFilter implements Filter {

	/**
	 * {@link Logger} implementation for logging.
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(GdprServiceFactoryFilter.class);
